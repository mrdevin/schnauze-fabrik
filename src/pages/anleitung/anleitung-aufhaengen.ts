...
export class AnleitungAufhaengen extends LitElement {
  ...
  render() {
    return html`
      ...
      <a download rel="noopener noreferrer" target="_blank" href="/flat-hex-title-hanging.pdf">Flat Tile Hanging Template</a>
      <br/>
      <a download rel="noopener noreferrer" target="_blank" href="/pointed-hex-title-hanging.pdf">Pointed Tile Hanging Template</a>
